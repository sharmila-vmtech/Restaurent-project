...
{{ Form::open( [ 'url' => 'delete_members', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
...
<div class="modal fade" id="e{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
{{ Form::open( [ 'url' => 'add_members', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
       <input type="hidden" name="id" id="hvid" value="{{$value->id}}">
      ...
      <input type="text" class="form-control input-sm" name="username" id="username"  value="{{$value->username}}" required >
      <br>
      <input type="password" class="form-control input-sm" name="password" id="password"  value="{{$value->password}}" required >
      <br>
      ...
      <select class="form-control input-sm" name="role" id="role"   required>
          ...
          <option value="User(waiter)">User(waiter)</option>
      </select>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel"> Add Members</h3>
      </div>
      <div class="modal-body">
{{ Form::open( [ 'url' => 'add_members', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
     ...
     <input type="text" class="form-control input-sm" name="username" id="username"  placeholder="User Name"  required >
      <br>
