          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="rounded active"><a href="#tab_1" data-toggle="tab">Admin</a></li>
               <li class="rounded"> <a data-toggle="modal" data-target="#add_Letters">Add Dish Type</a></li>
...
{{ Form::open( [ 'url' => 'delete_dish_type', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel"> Edit Dish Type</h3>
      </div>
      <div class="modal-body">
{{ Form::open( [ 'url' => 'add_dish_type', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
       <input type="hidden" name="id" id="hvid" value="{{$value->id}}">
      ...
      <input type="text" class="form-control input-sm" name="type" id="type"  value="{{$value->type}}" required >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Add Dish Type</h3>
      </div>
      <div class="modal-body">
{{ Form::open( [ 'url' => 'add_dish_type', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
     ...
     <input type="text" class="form-control input-sm" name="type" id="type"  placeholder="Dish Type"  required >
      <br>
