          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="rounded active"><a href="#tab_1" data-toggle="tab">Admin</a></li>
               <!-- <li class="rounded"> <a data-toggle="modal" data-target="#add_Letters">Add Purchase Items</a></li> -->
               <a data-toggle="modal" data-target="#add_Letters" class="btn btn-ls btn-primary" style="margin-top:5px;">Add Purchase Items</a>
              ...
              <div class="tab-pane active" id="tab_1">
                ...
                <?php foreach ($cat as $key => $value) {  ?>
                    <tr>
                        ...
                        <td><?php $name=get_pro_name($value->product); ?>{{$name}}</td>
                       
                        <td>{{$value->qty}}</td>
                        <td>{{$value->price}}</td>
                        <td>{{$value->gross_product}}</td>
...
{{ Form::open( [ 'url' => 'delete_purchase_product', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3>Edit Purchased Item</h3>
      </div>
      <div class="modal-body">
{{ Form::open( [ 'url' => '/add_purchase_product', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
       <input type="hidden" name="id" id="hvid" value="{{$value->id}}">
       <input type="hidden" name="edit" id="edit" value="1">
        ...
        <input type="text" class="form-control input-sm" name="supplier" id="supplier"  placeholder="Supplier Name"  value="{{$value->supplier}}" >
      <br>
      ...
      <br>
      <input type="text" class="form-control input-sm" name="qty" id="qty"  placeholder="Quantity" value="" >
      <br>
      <input type="text" class="form-control input-sm" name="price" id="price" placeholder="Price" value="" >
      <br>
...
{{ Form::open( [ 'url' => 'add_purchase_product', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
       ...
       <input type="text" class="form-control input-sm" name="supplier" id="supplier"  placeholder="Supplier Name"  required >
      <br>
      ...
      <br>
      <input type="text" class="form-control input-sm" name="qty" id="qty"  placeholder="Quantity"  required >
      <br>
...
function get_product(){
    $tab_get=\DB::table('stock_item')->Orderby('id','asc')->get();
    return $tab_get;
}

function get_pro_name($id)
{
    $table= \DB::table('stock_item')->where('id','=',$id)->get();
