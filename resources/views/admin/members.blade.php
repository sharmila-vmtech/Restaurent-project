  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Edit Members</h3>
      </div>
      <div class="modal-body">
{{ Form::open( [ 'url' => 'addtable', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      ...
      <input type="text" class="form-control input-sm" name="tablename" id="tablename"  placeholder="Location" value="{{$value->tablename}}" required >
      <br>
       <input type="text" class="form-control input-sm" name="tablestatus" id="tablestatus"  placeholder="Location" value="{{$value->tablestatus}}" required >
      <br>
