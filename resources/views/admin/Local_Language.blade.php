            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                ...
                <?php foreach ($Local_Language as $key => $value) {  ?>
                    <tr>
                        <td>{{$value->id}}</td>
                       <td>{{$value->Local_Language_title}}</td>
...
{{ Form::open( [ 'url' => 'add_Local_Language', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      ...
      <textarea name="Local_Language_name" class="form-control " placeholder="Local_Language_name" id="" cols="15" rows="5">{{$value->Local_Language_name}}</textarea>
      <br>
      <input type="text" class="form-control input-sm" name="Local_Language_title" id="Local_Language_name"  placeholder="Local_Language Name" value="{{$value->Local_Language_title}}" required >
      <br>
...
{{ Form::open( [ 'url' => 'add_Local_Language', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      ...
      <textarea name="Local_Language_name" class="form-control " placeholder="Local_Language_name" id="" cols="15" rows="5"></textarea> 
      <br>
      <input type="text" class="form-control input-sm" name="Local_Language_title" id="Local_Language_name"  placeholder="Local_Language title" value="" required >
      <br>
