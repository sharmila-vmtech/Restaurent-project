					...
					<div class="form-group">
						...
						<select name="table" class="form-control" id="">
							<?php 
								...
								?>
		<option value="{{$table_name}}" >{{$table_id}}</option>
				...
				<div class="col-lg-3 col-sm-3">
					<div class="form-group">
				<input type="text" name="order_id" id="order_id" class="form-control"  value="{{$f}}"  readonly>
					</div>
				</div>
				...
				<div class="col-lg-12 col-sm-12">
					<table class="table table-bordered">
						...
						<input type="text" name="productname[]" class="form-control productname" value="{{$value->dish_name}}" required>			
								</td>
					<input type="hidden" name="price[]" class="form-control price" value="{{$value->price}}">
						
					
					<td><input type="number" name="qty[]" class="form-control qty" value="{{$value->quantity}}" required></td>
					
					
					<input type="hidden" name="amount[]" class="form-control amount" readonly="true" value="{{$value->total}}">
 ...
 total();
						...
						<tfoot>
							<tr>
								...
								<td style="text-align: center"><input type="hidden" id="grand_total" name="grand_total" ><b class="total"></b></td>
								<!-- <td></td> -->
							</tr>
						</tfoot>
					</table>
					<input type="hidden" name="edit" class="form-control productname" value="1" required>	
...
$('.qty').on('click',function(){
 ...
 total();
	...
	function addRow() {
		var tr='<tr>'+								
					'<td>'+
					'<input type="text" name="productname[]" class="form-control productname" required>'+				
					'</td>'+
	...
	'<input type="hidden" name="amount[]" class="form-control amount" readonly="true">'+
'<td><a href="#" class="btn btn-danger remove"><i class="glyphicon glyphicon-remove"></i></a></td>'+						
'</tr>';
$('tbody').append(tr);
	};
