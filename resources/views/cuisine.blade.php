          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="rounded active"><a href="#tab_1" data-toggle="tab">Admin</a></li>
               <li class="rounded"> <a data-toggle="modal" data-target="#add_Letters">Add Cuisine</a></li>
              ...
              <div class="tab-pane active" id="tab_1">
                ...
                <?php foreach ($cat as $key => $value) {  ?>
                    <tr>
                        ...
                        <td>{{$value->cusinename}}</td>
                        <td>{{$value->cusineimage}}</td>
...
{{ Form::open( [ 'url' => 'delete_cuisine', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
...
<div class="modal fade" id="e{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
{{ Form::open( [ 'url' => 'add_cuisine', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
       <input type="hidden" name="id" id="hvid" value="{{$value->id}}">
      ...
      <input type="text" class="form-control input-sm" name="cusinename" id="tablename"  placeholder="Location" value="{{$value->cusinename}}" required >
      <br>
       <input type="file" class="form-control input-sm" name="cusineimage" id="tablestatus"  placeholder="Location" value="{{$value->cusineimage}}" required >
      <br>
...
{{ Form::open( [ 'url' => 'add_cuisine', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
       ...
       <input type="text" class="form-control input-sm" name="cusinename" id="tablename"  placeholder="Name" required >
      <br>
      <input type="file" class="form-control input-sm" name="cusineimage" id="tablename"  placeholder="name" required >
      <br>
