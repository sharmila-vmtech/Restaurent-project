          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="rounded active"><a href="#tab_1" data-toggle="tab">Admin</a></li>
               <li class="rounded"> <a data-toggle="modal" data-target="#add_Letters">Add Payment</a></li>
...
{{ Form::open( [ 'url' => 'delete_payment_type', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
...
<div class="modal fade" id="e{{$value->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
{{ Form::open( [ 'url' => 'add_payment_type', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
       <input type="hidden" name="id" id="hvid" value="{{$value->id}}">
      ...
      <input type="text" class="form-control input-sm" name="pay_type" id="pay_type"  placeholder="Name" value="{{$value->pay_type}}" required >
      <br>
...
{{ Form::open( [ 'url' => 'add_payment_type', 'class'=>'form-horizontal','method' => 'post', 'files' => true ] ) }}
      <div class="col-md-12">
       <input type="hidden" name="id" id="hvid" value="0">
        ...
        <input type="text" class="form-control input-sm" name="pay_type" id="pay_type"  placeholder="Name" required >
